...
<div class="container py-5">
    <div class="content-card" style="max-width: 800px; margin: 0 auto;">
        <div class="mb-4">
            ...
            <h2 class="page-title mb-2">Edit Task</h2>
            <p class="page-subtitle mb-0">Update your task details</p>
        </div>
            ...
            <div class="mb-4">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="is_completed" 
                           name="is_completed" value="1" {{ old('is_completed', $task->is_completed) ? 'checked' : '' }}>
